...
export function ChamberMap({ data, seating, view, selectedCode, hoveredSeat, hoveredPosition, seatByCode, identityAlliance, matchesFilters, alliances, onSelect, onHover, onNavigate }: {
  ...
  return <div className="seating-map-wrap">
    ...
    <div className="seating-map" role="group" aria-describedby="seating-keyboard-instructions" aria-label={`Pelan ${seating.mappedSeatCount} kerusi Parlimen yang dipetakan daripada PDF`}>
